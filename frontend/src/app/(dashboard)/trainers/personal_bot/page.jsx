    ...
    return (
        <>
            ...
            <div className="flex items-center justify-between p-3 border-b">
                ...
                <h1 className="text-xl font-semibold mt-2 mx-auto">Personal Agent</h1>
                <LayeredCard
                    mainColor="bg-accent"
                    bgColor="bg-primary"
                    borderWidth="border-[2px]"
                ...
                >
                    <Button variant="ghost" size="icon">
                        <Image src="/agents/personal_ai_agent.png" width={20} height={20} alt="wallet" />
                    </Button>
                </LayeredCard>
            </div>
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
                <div className="text-center text-gray-600">Welcome to Personal Agent Chat! 🎉</div>
