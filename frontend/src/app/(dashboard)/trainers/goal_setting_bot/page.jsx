...
export default function GoalSettingAgentChat() {
    const [messages, setMessages] = useState([]);
    const [input, setInput] = useState("");
    const [loading, setLoading] = useState(false);

    const agent = "goal_setting_bot";
    ...
    return (
        <>
            ...
            <div className="flex items-center justify-between p-3 border-b">
                ...
                <h1 className="text-xl font-semibold mt-2 mx-auto">Goal Setting Agent</h1>
                <LayeredCard
                    mainColor="bg-accent"
                    bgColor="bg-primary"
                    borderWidth="border-[2px]"
                ...
                >
                    <Button variant="ghost" size="icon">
                        <Image src="/agents/sports_goal_creation_agent.png" width={20} height={20} alt="wallet" />
                    </Button>
                </LayeredCard>
            </div>
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
                <div className="text-center text-gray-600">Welcome to Goal Setting Agent Chat! 🎉</div>
